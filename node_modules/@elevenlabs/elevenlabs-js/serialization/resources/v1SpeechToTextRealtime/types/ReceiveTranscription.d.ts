...
export declare namespace ReceiveTranscription {
    type Raw = SessionStartedPayload.Raw | PartialTranscriptPayload.Raw | FinalTranscript.Raw | FinalTranscriptWithTimestamps.Raw | CommittedTranscriptPayload.Raw | CommittedTranscriptWithTimestampsPayload.Raw | CommittedTranscriptEntitiesPayload.Raw | ScribeErrorPayload.Raw | ScribeAuthErrorPayload.Raw | ScribeQuotaExceededErrorPayload.Raw | ScribeThrottledErrorPayload.Raw | ScribeUnacceptedTermsErrorPayload.Raw | ScribeRateLimitedErrorPayload.Raw | ScribeQueueOverflowErrorPayload.Raw | ScribeResourceExhaustedErrorPayload.Raw | ScribeSessionTimeLimitExceededErrorPayload.Raw | ScribeInputErrorPayload.Raw | ScribeChunkSizeExceededErrorPayload.Raw | ScribeInsufficientAudioActivityErrorPayload.Raw | ScribeTranscriberErrorPayload.Raw;
}
