...
export declare namespace SystemToolConfigOutputParams {
    type Raw = SystemToolConfigOutputParams.EndCall | SystemToolConfigOutputParams.EndProcedure | SystemToolConfigOutputParams.KnowledgeBase | SystemToolConfigOutputParams.KnowledgeBaseRag | SystemToolConfigOutputParams.LanguageDetection | SystemToolConfigOutputParams.PlayKeypadTouchTone | SystemToolConfigOutputParams.RunSubagent | SystemToolConfigOutputParams.SkipTurn | SystemToolConfigOutputParams.StartProcedure | SystemToolConfigOutputParams.TransferToAgent | SystemToolConfigOutputParams.TransferToNumber | SystemToolConfigOutputParams.VoicemailDetection;
    ...
    interface KnowledgeBase extends KnowledgeBaseToolConfig.Raw {
    ...
    interface RunSubagent extends RunSubagentToolConfigOutput.Raw {
    ...
    interface TransferToAgent extends TransferToAgentToolConfigOutput.Raw {
        system_tool_type: "transfer_to_agent";
    }
    interface TransferToNumber extends TransferToNumberToolConfigOutput.Raw {
        system_tool_type: "transfer_to_number";
    }
    interface VoicemailDetection extends VoicemailDetectionToolConfig.Raw {
