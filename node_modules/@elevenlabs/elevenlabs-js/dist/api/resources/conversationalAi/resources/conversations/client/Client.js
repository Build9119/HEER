...
class ConversationsClient {
    ...
    __getSignedUrl(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_f = this._options.fetcher) !== null && _f !== void 0 ? _f : core.fetcher)({
                url: core.url.join((_h = (_g = (yield core.Supplier.get(this._options.baseUrl))) !== null && _g !== void 0 ? _g : (yield core.Supplier.get(this._options.environment))) !== null && _h !== void 0 ? _h : environments.ElevenLabsEnvironment.Production, "v1/convai/conversation/get-signed-url"),
                method: "GET",
                headers: _headers,
    ...
    __getWebrtcToken(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_f = this._options.fetcher) !== null && _f !== void 0 ? _f : core.fetcher)({
                url: core.url.join((_h = (_g = (yield core.Supplier.get(this._options.baseUrl))) !== null && _g !== void 0 ? _g : (yield core.Supplier.get(this._options.environment))) !== null && _h !== void 0 ? _h : environments.ElevenLabsEnvironment.Production, "v1/convai/conversation/token"),
                method: "GET",
                headers: _headers,
                queryString: core.url
                    .queryBuilder()
    ...
    __list() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p;
            const { cursor, agentId, visitedAgentIds, visitedAgentBranchIds, callSuccessful, callStartBeforeUnix, callStartAfterUnix, callDurationMinSecs, callDurationMaxSecs, ratingMax, ratingMin, hasFeedbackComment, userId, evaluationParams, dataCollectionParams, dataCollectionIds, evaluationCriteriaIds, toolNames, toolNamesSuccessful, toolNamesErrored, mainLanguages, pageSize, summaryMode, search, conversationInitiationSource, textOnly, conversationProductType, branchId, versionId, parentConversationId, topicIds, excludeStatuses, tagIds, workflowNodeEnteredId, terminationReasons, guardrailTypes, customGuardrailNames, } = request;
            const _queryParams = {
                cursor,
                agent_id: agentId,
                ...
                guardrail_types: Array.isArray(guardrailTypes)
                    ? guardrailTypes.map((item) => serializers.GuardrailType.jsonOrThrow(item, { unrecognizedObjectKeys: "strip" }))
                    : guardrailTypes != null
            ...
            const _response = yield ((_f = this._options.fetcher) !== null && _f !== void 0 ? _f : core.fetcher)({
                url: core.url.join((_h = (_g = (yield core.Supplier.get(this._options.baseUrl))) !== null && _g !== void 0 ? _g : (yield core.Supplier.get(this._options.environment))) !== null && _h !== void 0 ? _h : environments.ElevenLabsEnvironment.Production, "v1/convai/conversations"),
                method: "GET",
                headers: _headers,
                queryString: core.url
                    .queryBuilder()
    ...
    __resolve(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p;
            ...
            const _response = yield ((_f = this._options.fetcher) !== null && _f !== void 0 ? _f : core.fetcher)({
                url: core.url.join((_h = (_g = (yield core.Supplier.get(this._options.baseUrl))) !== null && _g !== void 0 ? _g : (yield core.Supplier.get(this._options.environment))) !== null && _h !== void 0 ? _h : environments.ElevenLabsEnvironment.Production, "v1/convai/conversations/resolve"),
                method: "GET",
                headers: _headers,
                queryString: core.url
                    .queryBuilder()
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/v1/convai/conversations/resolve");
        });
    }
    /**
    ...
    __get(conversation_id_1) {
        return __awaiter(this, arguments, void 0, function* (conversation_id, request = {}, requestOptions) {
            ...
            const _response = yield ((_f = this._options.fetcher) !== null && _f !== void 0 ? _f : core.fetcher)({
                url: core.url.join((_h = (_g = (yield core.Supplier.get(this._options.baseUrl))) !== null && _g !== void 0 ? _g : (yield core.Supplier.get(this._options.environment))) !== null && _h !== void 0 ? _h : environments.ElevenLabsEnvironment.Production, `v1/convai/conversations/${core.url.encodePathParam(conversation_id)}`),
                method: "GET",
                headers: _headers,
                queryString: core.url
                    .queryBuilder()
    ...
    __getSipMessages(conversation_id_1) {
        return __awaiter(this, arguments, void 0, function* (conversation_id, request = {}, requestOptions) {
            ...
            const _response = yield ((_f = this._options.fetcher) !== null && _f !== void 0 ? _f : core.fetcher)({
                url: core.url.join((_h = (_g = (yield core.Supplier.get(this._options.baseUrl))) !== null && _g !== void 0 ? _g : (yield core.Supplier.get(this._options.environment))) !== null && _h !== void 0 ? _h : environments.ElevenLabsEnvironment.Production, `v1/convai/conversations/${core.url.encodePathParam(conversation_id)}/sip-messages`),
                method: "GET",
                headers: _headers,
                queryString: core.url
                    .queryBuilder()
