...
export declare const WorkspaceResourceType: {
    ...
    readonly ConvaiKbExternalSyncJobs: "convai_kb_external_sync_jobs";
    ...
    readonly StudioProjects: "studio_projects";
    readonly ConvaiAnalysisItems: "convai_analysis_items";
};
