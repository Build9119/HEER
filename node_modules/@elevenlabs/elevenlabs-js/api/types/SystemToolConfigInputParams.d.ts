...
export declare namespace SystemToolConfigInputParams {
    ...
    interface EndProcedure extends ElevenLabs.EndProcedureToolConfigInput {
        systemToolType: "end_procedure";
    }
    interface KnowledgeBase extends ElevenLabs.KnowledgeBaseToolConfig {
        systemToolType: "knowledge_base";
    }
    interface KnowledgeBaseRag extends ElevenLabs.KnowledgeBaseRagToolConfig {
    ...
    interface RunSubagent extends ElevenLabs.RunSubagentToolConfigInput {
    ...
    interface TransferToAgent extends ElevenLabs.TransferToAgentToolConfigInput {
