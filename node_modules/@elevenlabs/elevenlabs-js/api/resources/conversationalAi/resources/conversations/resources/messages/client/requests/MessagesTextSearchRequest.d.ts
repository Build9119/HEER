...
export interface MessagesTextSearchRequest {
    ...
    excludeStatuses?: ElevenLabs.conversationalAi.conversations.MessagesTextSearchRequestExcludeStatusesItem | ElevenLabs.conversationalAi.conversations.MessagesTextSearchRequestExcludeStatusesItem[];
